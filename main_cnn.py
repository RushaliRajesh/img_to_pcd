...
from model_vpt_vit import Cnn_siamese
import time
import os
import pdb
...
keyword = "cross_meta_render_cnn_siamese"
...
transform_img = transforms.Compose([
        transforms.Resize((100, 100)),  # Resize to match ResNet input size
        transforms.ToTensor(),
...
model = Cnn_siamese(classes_total)

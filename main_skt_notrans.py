...
from model_vpt_vit import BeitClassifier_morelayers
import pdb
...
tr_dataset = ShapeData_notransform(
...
te_dataset = ShapeData_notransform(
    sketch_dir="/nlsasfs/home/neol/rushar/scripts/img_to_pcd/shrec_data/sketches/sketches_unzp/SHREC14LSSTB_SKETCHES/",
    model_dir="/nlsasfs/home/neol/rushar/scripts/img_to_pcd/shrec_data/target3d_np/",
...
for epoch in tqdm(range(num_epochs)):
    ...
    for name, param in model_skt.named_parameters():
    ...
    for ind,(sketches, pcds, target) in enumerate(tr_data_loader):
        ...
        if ind == 0:
            ...
            print("grads: ", [p.grad for p in model_skt.parameters() if p.requires_grad], flush=True)

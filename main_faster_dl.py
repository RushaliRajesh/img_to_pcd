...
from data_debug import ShapeData, pairing 
...
tr_pairs = pairing(sketch_models = m_s_temp,models_3d= m_tr)
...
te_pairs = pairing(sketch_models = m_s_test_temp,models_3d= m_te)
